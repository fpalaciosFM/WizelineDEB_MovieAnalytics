...
$voice.rate = 0
$voice.volume = 100
$voice.speak("Airflow Initialization Script for Wizeline's Data Engineer Bootcamp, has started", 1) > $null
...
$voice.speak("Creating infrastructure, please confirm terraform plan", 1) > $null
terraform apply --var-file=terraform.tfvars

$voice.speak("Infrastucture creation complete, Installing Airflow", 1) > $null
...
$voice.speak("The script has finished!", 1) > $null
